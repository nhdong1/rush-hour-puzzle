...
class ControlTab:
    ...
    def _setup_ui(self):
        ...
        ttk.Label(stats_grid, text="Số lượt đi:").grid(row=1, column=0, sticky=tk.W, pady=2)
        ...
        info_frame = ttk.LabelFrame(self.frame, text="Thông tin game", padding="15")
        info_frame.pack(fill=tk.X, pady=(0, 10))

        info_text = """Cờ Thú - Animal Chess
        
• Bàn cờ 4x4 với 16 ô
• 8 loại quân: Chuột, Mèo, Chó, Cáo, Sói, Hổ, Sư tử, Voi
• Chuột (1) ăn được Voi (8) - quy tắc đặc biệt
• Quân mạnh hơn hoặc bằng có thể ăn quân yếu hơn
• Mục tiêu: Kiếm nhiều điểm nhất trong 40 lượt"""
